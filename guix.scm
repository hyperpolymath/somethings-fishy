...
;;
;; Guix package definition for Something's [Robo] Fishy
;;
;; Usage:
;;   guix shell -D -f guix.scm    # Enter development shell
;;   guix build -f guix.scm       # Build package
;;
;; TODO: Replace Something's [Robo] Fishy and customize inputs for your language/stack.
...
(package
  ...
  (home-page "https://github.com/hyperpolymath/Something's [Robo] Fishy")
  (synopsis "Agent-damage triage tool — checks whether LLM agents have broken a repo")
